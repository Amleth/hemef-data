...
def check(xlsx_file, divergences_file):
    ...
    cdlvndpddulal = [
        ...
        "eleve_refs_bibliographiques",
        "eleve_cote_AN_registre",
        "eleve_observations",
        "eleve_remarques de saisie",
        "recommandation_date",
        "recommandation_qualiterecommandeur",
        "recommandation_type",
        "cursus_motif_admission",
        "cursus_date_epreuve_admission",
        "cursus_date_entree_conservatoire",
        "cursus_date_sortie_conservatoire",
        "cursus_motif_sortie",
        "exerce_distinctions",
        "exerce_profession_connue",
        "exerce_date_debut",
        "exerce_lieu_exercice",
        "profession_nom",
        "profession_secteur",
    ...
    for id, row in pandas.read_excel(xlsx_file, sheet_name="Sheet1", encoding='utf-8').iterrows():
